...
public class ClientController {
    ...
    public ResultResponse<Boolean> register(@RequestBody Client client) {
        ...
        RegisteredClient build = RegisteredClient.withId(UUID.randomUUID().toString()).clientId(entity.getClientId())
                ...
                .postLogoutRedirectUri(entity.getPostLogoutRedirectUris()).authorizationGrantTypes(
        ...
        return new ResultResponse<Boolean>().success();
    }
