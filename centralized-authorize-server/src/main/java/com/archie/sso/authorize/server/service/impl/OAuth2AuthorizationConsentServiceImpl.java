...
public class OAuth2AuthorizationConsentServiceImpl extends ServiceImpl<OAuth2AuthorizationConsentMapper, OAuth2AuthorizationConsentEntity> implements OAuth2AuthorizationConsentService, AuthorizationConsentService {
    ...
    public OAuth2AuthorizationConsent findById(String registeredClientId, String principalName) {
        ...
        List<OAuth2AuthorizationConsentEntity> consentEntities = this.baseMapper.selectList(
                Wrappers.lambdaQuery(OAuth2AuthorizationConsentEntity.class)
                        .eq(OAuth2AuthorizationConsentEntity::getRegisteredClientId, registeredClientId)
                        .eq(OAuth2AuthorizationConsentEntity::getPrincipalName, principalName));
